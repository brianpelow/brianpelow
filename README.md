...
I work on the hard problems in fintech, manufacturing, and regulated software â€” where engineering excellence isn't optional and the blast radius of getting it wrong is real. My open-source work reflects the kind of platform and tooling investments I've led and care about: developer productivity, operational reliability, compliance automation, and the agentic future of engineering operations.
...
| Repo | What it does |
|------|-------------|
| [IncidentPilot](https://github.com/brianpelow/IncidentPilot) | Multi-agent incident response â€” triage, escalation, runbook retrieval, and post-mortem drafting with LangGraph |
...
| [BoardroomBrief](https://github.com/brianpelow/BoardroomBrief) | Autonomous weekly engineering brief â€” pulls GitHub, JIRA, and incident data into exec-ready narratives |
...
| [mcp-developer-portal](https://github.com/brianpelow/mcp-developer-portal) | Wraps Backstage â€” lets AI agents query the service catalog, fetch TechDocs, and scaffold services |
...
| [TechDebtLedger](https://github.com/brianpelow/TechDebtLedger) | Scans repos for complexity hotspots and stale dependencies â€” produces a prioritized payoff roadmap |
...
| [service-catalog-sync](https://github.com/brianpelow/service-catalog-sync) | Automated Backstage catalog hydration â€” scans repos and infers ownership and tech stack |
...
- **Real working code** â€” not toy examples. Each tool solves a genuine problem.
- **Test suites** â€” 324 passing tests across 15 repos. CI on every push.
- **Agentic automation** â€” every repo has a nightly GitHub Actions agent that does real work and commits results autonomously.
- **Regulated industry context** â€” fintech, manufacturing, and regulated software are first-class concerns throughout.
- **Professional structure** â€” CHANGELOG, CONTRIBUTING, LICENSE, CODEOWNERS, ADR directory, and PR templates on every repo.

---

## Industry focus

**Fintech / Banking** â€” PCI-DSS, SOX ITGC, FFIEC, ISO 20022
**Manufacturing** â€” IEC 62443, ISO 9001, ISO 27001
**Regulated SaaS** â€” SOC 2 Type II, continuous compliance, audit trail automation

---

## Technology

**Languages**: Python Â· TypeScript
**Agentic**: LangGraph Â· FastMCP Â· Anthropic Claude
**Platform**: Backstage Â· GitHub Actions Â· Kubernetes Â· Terraform
**Observability**: Dynatrace Â· PagerDuty Â· Prometheus Â· Grafana
**Standards**: DORA Â· SPACE Â· SOC 2 Â· ISO 27001 Â· PCI-DSS
